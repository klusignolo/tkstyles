...
setup(
  ...
  version = '0.1.2beta',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/klusignolo/tkstyles/releases/tag/0.1.2',    # I explain this later on
